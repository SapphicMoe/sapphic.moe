...
Unfortunately, the game will not automatically change your desktop wallpaper on Linux during a certain puzzle in the Glen region. We have not found a solution for this issue.

For the time being, you can change the wallpaper manually by going to the `~/.steam/steam/steamapps/common/OneShot/Wallpaper` and selecting `desktop.png` as your wallpaper. You can change the wallpaper back after you're done with the puzzle.
