...
<Caption src={{"discriminant":false,"value":"/images/article/oneshot-on-linux/compatibility-tab.png"}} alt="Compatibility tab for OneShot with Proton version 7.0-6 being selected." caption="Compatibility tab for OneShot.">
...
<Spoiler
  description="OneShot and the clover program being open at the same time near the end of the game"
