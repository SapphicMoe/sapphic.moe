...
![The Steam compatibility tab for OneShot with Proton version 7.0-6 being selected.](https://elixi.re/i/svtnl.png "The Steam compatibility tab for OneShot.")
...
![GNOME File Explorer (Nautilus) showing the ProtonDocuments symlink in your home directory's Documents folder.](https://elixi.re/i/fpbhf.png "The ProtonDocuments symlink in your home directory's Documents folder.")
...
<Spoiler
  ...
  image="https://elixi.re/i/yprwr.png"
...
![The OneShotSaves symlink in your home directory's Documents folder. It contains your save files for OneShot, as well as some configuration files.](https://elixi.re/i/0nlwl.png "The OneShotSaves symlink in your home directory's Documents folder. It contains your save files for OneShot, as well as some configuration files.")
