...
![The Steam compatibility tab for OneShot with Proton version 7.0-6 being selected.](/images/article/oneshot-on-linux/compatibility-tab.png "The Steam compatibility tab for OneShot.")
...
![GNOME File Explorer (Nautilus) showing the ProtonDocuments symlink in your home directory's Documents folder.](/images/article/oneshot-on-linux/protondocuments.png "The ProtonDocuments symlink in your home directory's Documents folder.")
...
<Spoiler
  ...
  image="/images/article/oneshot-on-linux/spoiler-clover-program.png"
...
![The OneShotSaves symlink in your home directory's Documents folder. It contains your save files for OneShot, as well as some configuration files.](/images/article/oneshot-on-linux/oneshotsaves.png "The OneShotSaves symlink in your home directory's Documents folder. It contains your save files for OneShot, as well as some configuration files.")
